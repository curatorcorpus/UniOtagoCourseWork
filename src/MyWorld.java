...
public class MyWorld extends World {
  ...
  */
  private final int _perceptFormat = 1;
  ...
  */
  public MyWorld(int gridSize, int windowWidth, int windowHeight, boolean repeatableMode) {   
      ...
      super(gridSize, windowWidth,  windowHeight, repeatableMode);
      ...
      this.selectPerceptFormat(_perceptFormat);
  ...
  */
  public static void main(String[] args) {
     ...
     MyWorld sim = new MyWorld(gridSize, windowWidth, windowHeight, repeatableMode);
  }
